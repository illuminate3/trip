                    ...
                    <div class="section-content">
                        <ul class="archive-list">
                            ...
                            <li>
                                    <div class="wrap">
                                        <div class="img-wrap">
                                            <img src="{{ asset('uploads/images/tour/packages/'.$package->image) }}" alt="">
                                        </div>
                                        <div class="long-desc">
                                            <div class="row">
                                                <h4 class="float-left">{{ $package->name }}</h4>
                                                <div class="star float-right"></div>
                                            </div>
                                            <div class="row">
                                                <p class="address">{{ $package->type }}</p>
                                            </div>
                                            <hr>
                                            <div class="row">
                                            ...
                                            <hr>
                                            <div class="row">
                                                <p class="mb">{{ $package->description }}</p>
                                                <a href="#" class="more-info">More info</a>
                                            </div>

                                            <hr class="darker">
                                            <a href="{{ url('tours/'.$slug.'/package/'.$package->id)}}" class="button">More Info</a>
                                        </div>
                                    </div>
                                </li>
